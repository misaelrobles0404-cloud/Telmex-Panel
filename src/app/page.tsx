                                            ...
                                            <button
                                                onClick={async () => {
                                                    try {
                                                        ...
                                                        mostrarToast(`📢 Aviso enviado a ${estadoPortal.en_uso_por}`);
                                                    } catch { mostrarToast('Error al enviar aviso'); }
                                                }}
                                                disabled={alertaPortalEnviada || !!estadoPortal.alerta_pedida_por}
                                                className="rounded-xl py-1 px-2 border w-full flex items-center justify-center gap-1 text-[9px] font-black uppercase tracking-wide bg-orange-50 border-orange-200 text-orange-600 hover:bg-orange-100 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
                                            >
                                                📢 {estadoPortal.alerta_pedida_por ? 'Aviso enviado' : 'Avisar que me tardo'}
                                            </button>
                                        )}
                                    </>
                                );
